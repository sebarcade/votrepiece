    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '36px' }}>
          ...
          <h1 style={{ fontFamily: 'var(--font-title)', fontSize: '1.5rem', fontWeight: 800, marginBottom: '4px' }}>
            Votre<span style={{ color: 'var(--color-primary)' }}>Pièce</span>
          </h1>
          <p style={{ color: 'var(--color-text-muted)', fontSize: '0.9rem' }}>Administration</p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          {error && (
            <div style={{ background: '#fef2f2', border: '1px solid #fca5a5', color: '#dc2626', padding: '12px', borderRadius: '8px', fontSize: '0.85rem' }}>
              ❌ {error}
            </div>
          )}
          <button
